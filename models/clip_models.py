...
class ZeroShotClip(nn.Module):
    ...
    def init_text(self, dataset): 
        ...
        if dataset in ['imagenet', 'imagenet-sketch', 'imagenet-c1', 'imagenet-c2', 'imagenet-c3', 'imagenet-c4', 'imagenet-c5', 'imagenetv2', 'officehome-product', 'officehome-realworld', 'cifar100', 'fruits360', 'fashion1M', 'fashion1m', 'food-101', 'lsun-scene', 'office31-amazon', 'office31-dslr', 'office31-webcam', 'fashion-mnist', 'objectnet', 'officehome-art', 'officehome-clipart']:
            classes = [
